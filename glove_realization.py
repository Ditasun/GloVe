# -*- coding: utf-8 -*-
"""glove_realization.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XM3xwYqOV0_nnzR42f3bHn2Jmy86grRq
"""
...
def gen_batch():
    ...
    for chosen in sample:
        ind = tuple(transp[chosen])
        l_vecs.append(left_emb[ind[0]])
        r_vecs.append(right_emb[ind[1]])
...
if embed_size == 2:
    ...
    for word_ind in word_inds:
        word_embed = (left_emb[word_ind].data + right_emb[word_ind].data).numpy()
        x, y = word_embed[0][0], word_embed[1][0]
        plt.scatter(x, y)
